...
class AppColors {
  ...
  static final Color mainColor = const Color(0xFF5b5f97);
  static final Color secondmainColor = const Color(0xFF5b5f97);
  static final Color secondmainColo222r = const Color(0xFF5b5f97);
