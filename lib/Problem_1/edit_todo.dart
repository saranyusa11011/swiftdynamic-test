...
import 'package:swift_test/model/model_todolist.dart';
...
class EditTodoScreen extends StatefulWidget {
  EditTodoScreen({Key? key, required this.data}) : super(key: key);
  Todolist data;
  @override
  _EditTodoScreenScreenState createState() => _EditTodoScreenScreenState();
}

class _EditTodoScreenScreenState extends State<EditTodoScreen> {
  late String todo = widget.data.todo;
  ...
  late String date = widget.data.date.substring(0, 10);
  ...
  late String timetext = ' ${widget.data.date.substring(11, 16)}';
